...
//                    Log.d("wangping", String.format("dx:%d", dx));
    ...
    private void onScrolledChangedCallback() {
        ...
        Log.d("wangping", String.format("leftPos:%s, currentPos:%s, rightPos:%s",
                (mCurrentItemPos - 1 == -1) ? (mRecyclerView.getAdapter().getItemCount() - 1) : (mCurrentItemPos - 1),
                mCurrentItemPos,
                (mCurrentItemPos + 1 == mRecyclerView.getAdapter().getItemCount()) ? 0 : (mCurrentItemPos + 1)));
