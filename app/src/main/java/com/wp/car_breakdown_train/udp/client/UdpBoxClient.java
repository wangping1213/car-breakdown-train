 ...
 */
public class UdpBoxClient implements IUdpClient {
    private static MulticastSocket ms;
    private static InetAddress address;

    private static UdpBoxClient udpBoxClient;

    private UdpBoxClient() {}


    public static UdpBoxClient newInstane() {
        if (null == udpBoxClient) {
            udpBoxClient = new UdpBoxClient();
        }
        return udpBoxClient;
    }
...
//        JSONObject jsonObject = UdpSystem.search();
//        String deviceNo = "";
//        if (null != jsonObject) {
...
//        }
        IUdpClient udpClient = UdpClientFactory.getUdpClient(null);
