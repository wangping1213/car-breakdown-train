package com.wp.car_breakdown_train.util;
...
public class WifiUtil {
    ...
    // 构造函数
    private WifiUtil(WifiManager wifiManager) {
        this.wifiManager = wifiManager;
    }

    public static WifiUtil newInstance(WifiManager wifiManager) {
        if (mWifiUtil == null) {
            mWifiUtil = new WifiUtil(wifiManager);
        }
        return mWifiUtil;
    }
    ...
    public WifiConfiguration isExsits(String SSID) {
        ...
        for (WifiConfiguration existingConfig : existingConfigs) {
            if (existingConfig.SSID.equals(String.format("\"%s\"", SSID))) {
...
//            config.status = WifiConfiguration.Status.ENABLED;
    ...
    public static String getGateway() {
        ...
        InetAddress inetAddress = NetworkUtil.intToInetAddress(wifiManager.getDhcpInfo().gateway);
        if (inetAddress == null) {
            return "";
        }
    ...
    public static String getIpAddress(){
        ...
        InetAddress inetAddress = NetworkUtil.intToInetAddress(wifiManager.getConnectionInfo().getIpAddress());
        if (inetAddress == null) {
            return "";
        }
        return inetAddress.getHostAddress();
